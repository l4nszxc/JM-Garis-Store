...
-- Exported on 2025-10-07T09:01:16.177Z
-- Database: railway

SET FOREIGN_KEY_CHECKS = 0;

-- Table: available_discounts
DROP TABLE IF EXISTS `available_discounts`;
...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`products_id`),
  CONSTRAINT `cart_ibfk_3` FOREIGN KEY (`choice_id`) REFERENCES `product_choices` (`choice_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2491909 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Data for table: loyalty_tiers
INSERT INTO `loyalty_tiers` (`id`, `name`, `min_spend`, `max_spend`, `bonus_percentage`, `has_free_product`, `created_at`) VALUES
(1, 'Bronze', '10000.00', '15000.00', '5.00', 0, '2025-06-30 05:50:00'),
(2, 'Silver', '16000.00', '20000.00', '10.00', 0, '2025-06-30 05:50:00'),
(3, 'Gold', '21000.00', NULL, '15.00', 1, '2025-06-30 05:50:00');
...
(62, 'order-2132942-pending', 1014, 'Order Update', 'Order #2132942 has been placed and is pending.', 'order', 'fas fa-hourglass-half', 0, 0, '2025-09-16 01:01:10', '2025-09-16 01:01:10', '2132942', '/order-details/2132942'),
(63, 'order-8936241-pending', 1014, 'Order Update', 'Order #8936241 has been placed and is pending.', 'order', 'fas fa-hourglass-half', 0, 0, '2025-09-16 01:02:10', '2025-09-16 01:02:10', '8936241', '/order-details/8936241'),
(65, 'order-8936241-paid', 1014, 'Order Update', 'Order #8936241 has been paid and completed.', 'order', 'fas fa-money-bill-wave', 0, 0, '2025-09-16 01:03:00', '2025-09-16 01:03:00', '8936241', '/order-details/8936241'),
(66, 'order-2132942-ready for pickup', 1014, 'Order Update', 'Order #2132942 is ready for pickup!', 'order', 'fas fa-check-circle', 0, 0, '2025-09-16 01:07:34', '2025-09-16 01:07:34', '2132942', '/order-details/2132942'),
(68, 'order-2132942-paid', 1014, 'Order Update', 'Order #2132942 has been paid and completed.', 'order', 'fas fa-money-bill-wave', 0, 0, '2025-09-16 01:09:33', '2025-09-16 01:09:33', '2132942', '/order-details/2132942'),
...
CREATE TABLE `order_items` (
  ...
  KEY `order_id` (`order_id`),
  KEY `product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5315 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data for table: order_items
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `quantity`, `price`, `choice_id`) VALUES
(4262, 'PO00001', 33, 1, '649.00', NULL),
(4263, '2132942', 50, 2, '185.00', NULL),
(4264, '8936241', 50, 2, '185.00', NULL),
...
(5306, 'PO00117', 38, 3, '31.00', 231),
(5307, 'PO00118', 82, 1, '8.00', NULL),
(5308, 'PO00119', 81, 1, '8.00', NULL),
(5309, 'PO00120', 41, 2, '22.50', NULL),
(5310, 'PO00121', 80, 1, '12.00', NULL),
(5311, 'PO00122', 143, 1, '31.00', 155),
(5312, 'PO00123', 31, 1, '301.00', NULL),
(5313, 'PO00123', 32, 2, '234.00', NULL),
(5314, 'PO00124', 32, 3, '234.00', NULL);
...
('2132942', 1014, '370.00', 'paid', 'pending', '2025-09-16 01:01:01', '2025-09-16 01:09:12', NULL, 1017, '2025-09-16 01:07:13', '400.00', '30.00', NULL, 0, 'eco', NULL, 'cash'),
('8936241', 1014, '370.00', 'paid', 'pending', '2025-09-16 01:01:07', '2025-09-16 01:02:44', NULL, 1017, '2025-09-16 01:02:12', '400.00', '30.00', NULL, 0, 'eco', NULL, 'cash'),
('PO00001', 1017, '649.00', 'paid', 'pending', '2025-09-16 00:56:12', '2025-09-16 00:57:20', NULL, 1017, '2025-09-16 00:56:12', '700.00', '51.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
...
('PO00117', 1017, '93.00', 'paid', 'pending', '2025-09-30 22:47:41', '2025-09-30 22:48:27', NULL, 1017, '2025-09-30 22:47:41', '100.00', '7.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00118', 1017, '8.00', 'paid', 'pending', '2025-09-30 22:56:41', '2025-09-30 22:58:01', NULL, 1017, '2025-09-30 22:56:41', '10.00', '2.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00119', 1017, '8.00', 'paid', 'pending', '2025-09-30 23:02:12', '2025-09-30 23:03:03', NULL, 1017, '2025-09-30 23:02:12', '10.00', '2.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00120', 1017, '45.00', 'paid', 'pending', '2025-09-30 23:06:27', '2025-09-30 23:06:58', NULL, 1017, '2025-09-30 23:06:27', '100.00', '55.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00121', 1017, '12.00', 'paid', 'pending', '2025-09-30 23:08:41', '2025-09-30 23:08:55', NULL, 1017, '2025-09-30 23:08:41', '12.00', '0.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00122', 1017, '31.00', 'paid', 'pending', '2025-09-30 23:10:48', '2025-10-06 23:25:51', NULL, 1017, '2025-09-30 23:10:48', '40.00', '9.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00123', 1017, '769.00', 'paid', 'pending', '2025-10-06 23:40:20', '2025-10-06 23:42:58', NULL, 1017, '2025-10-06 23:40:20', '1000.00', '231.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash'),
('PO00124', 1017, '702.00', 'paid', 'pending', '2025-10-07 00:51:03', '2025-10-07 00:51:19', NULL, 1017, '2025-10-07 00:51:03', '800.00', '98.00', 'Walk-in Customer', 1, 'eco', NULL, 'cash');
...
CREATE TABLE `payment_intents` (
  ...
  KEY `idx_paymongo_link_id` (`paymongo_link_id`),
  CONSTRAINT `payment_intents_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE
...
(1, 0, NULL, NULL, 'test', 0, '25.00', '500.00', '2025-09-09 09:29:41', '2025-09-14 06:32:34', 20);
...
-- Data for table: product_choices
...
(42, 101, '155', '42.00', 16, NULL),
(43, 101, '425', '110.00', 10, NULL),
(44, 102, 'Red', '26.50', 50, NULL),
(45, 102, 'Green', '26.50', 50, NULL),
(46, 103, '170g', '67.00', 21, NULL),
(47, 103, '397g', '131.00', 24, NULL),
(48, 104, '155g', '45.00', 36, NULL),
(49, 104, '425g', '100.00', 12, NULL),
(50, 105, '85g', '31.00', 94, NULL),
(51, 105, '230g', '66.00', 60, NULL),
(52, 107, 'Orange', '84.00', 39, NULL),
(53, 107, 'Grape', '84.00', 37, NULL),
(54, 107, 'Apple', '84.00', 97, NULL),
(55, 113, 'Coke Mismo', '203.00', 93, 'https://i.ibb.co/ksMvMh8H/eccf0110a173.png'),
(56, 113, 'Royal Mismo', '203.00', 48, 'https://i.ibb.co/MyFbvKfP/02fb6e4955f6.png'),
(57, 113, 'Sprite Mismo', '203.00', 50, 'https://i.ibb.co/B5hQp3zB/c63551d74bd7.png'),
(58, 114, '1.5 Coke', '722.00', 17, 'https://i.ibb.co/Y7W1c1pc/5ca33bf6a13a.png'),
...
(64, 116, 'Chocolate', '58.00', 16, 'https://i.ibb.co/Gvm29r3N/954f9a2f6be6.png'),
(65, 116, 'Flavor Bunch Assorted', '58.00', 14, 'https://i.ibb.co/9k7PNJ5m/4a91171d5a1d.png'),
(66, 120, 'Hansel Choco', '58.00', 147, 'https://i.ibb.co/nN97krfx/bac16d385dc5.png'),
(67, 120, 'Hansel Mocha', '58.00', 145, 'https://i.ibb.co/JwMyJZk2/c84e1afc4c18.png'),
(68, 120, 'Hansel Milk', '58.00', 147, 'https://i.ibb.co/bMM1N0hJ/e97cce0da8f0.png'),
(69, 120, 'Hansel Butter', '58.00', 149, 'https://i.ibb.co/B5TpHvGS/2960fc9474a9.png'),
(70, 120, 'Hansel Flavor Bunch', '58.00', 147, 'https://i.ibb.co/Q3vg9YCW/e073221a0f74.png'),
(71, 122, 'White', '72.00', 23, 'https://i.ibb.co/qFpjX1V7/cfbb7c1d9246.png'),
(72, 122, 'Choco', '72.00', 22, 'https://i.ibb.co/67LSfJWD/6addd661a002.png'),
(73, 124, 'Milk', '58.00', 10, 'https://i.ibb.co/5X7t0yFM/8fb7551ce701.png'),
(74, 124, 'Choco', '58.00', 8, 'https://i.ibb.co/vyTkmP6/3ad414c49332.png'),
(75, 127, 'Choco', '78.00', 18, 'https://i.ibb.co/fbyDy02/9cc0f97653cc.png'),
(76, 127, 'Macapuno', '78.00', 24, 'https://i.ibb.co/Y75qVX93/3605d4abd7d2.png'),
(77, 127, 'Salted Caramel', '78.00', 25, 'https://i.ibb.co/fGBj52Gg/5ef06f784445.png'),
(78, 127, 'Vanilla', '78.00', 24, 'https://i.ibb.co/DPkvSbpv/4caa36155d8f.png'),
...
(82, 127, 'Assorted', '78.00', 18, 'https://i.ibb.co/W4FMNyVL/6c0d792aad26.png'),
(83, 129, 'Choco', '77.00', 14, 'https://i.ibb.co/JFxPhLw5/3f865e3665f4.png'),
(84, 129, 'Assorted', '96.00', 9, 'https://i.ibb.co/Z6qVpQcN/f3db2131b5b5.png'),
(85, 131, '100g', '20.00', 50, NULL),
(86, 131, '150g', '25.00', 50, NULL),
(87, 132, 'Green', '26.00', 98, NULL),
(88, 132, 'Red', '26.00', 98, NULL),
(89, 133, 'Green', '25.00', 493, NULL),
(90, 133, 'Red', '25.00', 492, NULL),
(91, 74, '375ml', '32.00', 1221, 'https://i.ibb.co/N25PWXHW/e71758e8ad02.png'),
(92, 132, 'zxc', '32.00', 32, NULL),
(93, 75, 'hdftuh', '25.00', 42547, NULL),
(95, 72, '33g (sold per tie)', '93.00', 115, NULL),
(96, 72, '90g', '37.00', 47, NULL),
(97, 72, '135g', '54.00', 50, NULL),
(98, 72, '300g', '114.00', 93, NULL),
(99, 72, '680g', '255.00', 16, NULL),
...
(105, 74, '33g (sold per tie)', '93.00', 239, NULL),
(106, 74, '300g', '114.00', 19, NULL),
(107, 74, '840g', '307.00', 5, NULL),
(108, 73, '33g (sold per tie)', '141.00', 156, NULL),
(109, 73, '180g', '98.00', 12, NULL),
(110, 73, '300g', '135.00', 17, NULL),
(111, 73, '600g', '270.00', 9, NULL),
(112, 73, '1kg', '495.00', 5, NULL),
(113, 73, '1.2kg', '545.00', 5, NULL),
(114, 75, '24g (1 dozen)', '112.00', 74, NULL),
(115, 75, '150g', '54.00', 15, NULL),
(116, 75, '300g', '100.00', 11, NULL),
(117, 75, '600g', '197.00', 7, NULL),
(118, 75, '1kg', '300.00', 5, NULL),
(119, 76, '33g (9+3 promo)', '84.00', 463, NULL),
(120, 76, '135g', '51.00', 24, NULL),
(121, 76, '300g', '98.00', 26, NULL),
(122, 76, '660g', '235.00', 15, NULL),
(123, 76, '925g', '305.00', 15, NULL),
(124, 76, '2kg', '619.00', 6, NULL),
(125, 135, 'Brown', '132.00', 182, NULL),
(126, 135, 'Black', '132.00', 197, NULL),
(127, 135, 'Blanca', '132.00', 176, NULL),
(128, 135, 'Cafe Mocha', '131.00', 197, NULL),
(129, 136, 'Choco', '128.00', 198, NULL),
(130, 136, 'White', '128.00', 189, NULL),
(131, 136, 'Original', '86.00', 199, NULL),
(132, 137, 'Stick (per pack)', '23.00', 100, NULL),
(133, 137, '23g', '46.00', 100, NULL),
(134, 137, '46g', '92.00', 100, NULL),
(135, 137, '92g', '92.00', 91, NULL),
(136, 112, '1L', '65.00', 100, NULL),
(137, 138, 'Original', '135.00', 189, NULL),
(138, 138, 'Creamy White', '135.00', 192, NULL),
(139, 138, 'CreamyLatte', '135.00', 20, NULL),
(140, 139, '80g', '25.00', 78, NULL),
(141, 139, '150g', '52.00', 98, NULL),
(142, 139, '220g', '64.00', 50, NULL),
(143, 139, '400g', '117.00', 30, NULL),
(144, 140, '80g', '28.00', 79, NULL),
(145, 140, '150g', '50.00', 43, NULL),
(146, 140, '220g', '74.00', 50, NULL),
(147, 140, '400g', '119.00', 48, NULL),
(148, 141, '25g', '22.00', 160, NULL),
(149, 141, '50g', '43.00', 97, NULL),
(150, 141, '100g', '83.00', 97, NULL),
(151, 142, '25g', '21.50', 78, NULL),
(152, 142, '50g', '40.00', 99, NULL),
(153, 142, '100g', '80.00', 100, NULL),
(154, 143, '3g (per tie)', '83.00', 271, NULL),
(155, 143, '55g', '31.00', 49, NULL),
(156, 143, '150g', '72.00', 47, NULL),
(157, 144, 'Blue Pack', '66.00', 85, NULL),
(158, 144, 'Yellow Pack', '53.00', 98, NULL),
(159, 144, '50g', '16.00', 100, NULL),
(160, 144, '100g', '41.00', 98, NULL),
(161, 144, '250g', '69.00', 50, NULL),
(162, 144, '500g', '115.00', 50, NULL),
(163, 146, 'Chicken', '6.50', 140, NULL),
(164, 146, 'Pork', '6.50', 164, NULL),
(165, 146, 'Beef', '6.50', 194, NULL),
(166, 146, 'Shrimp', '6.50', 200, NULL),
(167, 147, '11g (12+1)', '90.00', 43, NULL),
(168, 147, '22g (6''s with plate)', '94.00', 49, NULL),
(169, 147, 'Sinigang sa Gabi (11g) per tie', '93.00', 72, NULL),
(170, 152, 'Choco', '44.00', 25, NULL),
(171, 152, 'Milk', '44.00', 49, NULL),
(172, 153, 'Tropical', '36.00', 43, NULL),
(173, 153, 'Tamarind', '36.00', 31, NULL),
(174, 154, 'Orange', '34.00', 39, NULL),
(175, 154, 'Corn', '34.00', 40, NULL),
(176, 154, 'Ponkan', '34.00', 39, NULL),
(177, 155, 'Minis', '87.00', 20, NULL),
(178, 155, '12 pcs per box', '98.00', 46, NULL),
(179, 157, 'Choco', '88.00', 17, NULL),
(180, 157, 'White', '88.00', 20, NULL),
(181, 157, 'Dark Choco', '88.00', 18, NULL),
(182, 158, 'Honey lemon', '42.00', 97, NULL),
(183, 158, 'Dalandan Orange', '42.00', 95, NULL),
(184, 158, 'Fresh', '42.00', 99, NULL),
(185, 158, 'Eucalyptus', '42.00', 100, NULL),
(186, 158, 'Extra Strength', '42.00', 100, NULL),
(187, 158, 'Cherry', '42.00', 96, NULL),
(188, 159, 'Calamansi Clean', '38.00', 89, NULL),
(189, 159, 'Floral Fresh', '38.00', 94, NULL),
(190, 159, 'Summer Sunshine', '38.00', 97, NULL),
(191, 159, 'Total Care', '38.00', 100, NULL),
(192, 160, 'Cherry Blossom', '42.00', 168, NULL),
(193, 160, 'Rose Fresh', '42.00', 186, NULL),
(194, 160, 'Tawas', '42.00', 200, NULL),
(195, 160, 'Sunfresh', '42.00', 194, NULL),
(196, 164, '500g', '64.00', 10, NULL),
(197, 164, '1kg', '125.00', 9, NULL),
(198, 164, '2kg', '235.00', 10, NULL),
(199, 166, 'Floral Pink', '129.00', 97, NULL),
(200, 166, 'Lemon Fresh', '129.00', 94, NULL),
(201, 167, 'Orange', '21.00', 102, NULL),
(202, 167, 'Green', '21.00', 60, NULL),
(203, 168, 'Blue', '17.00', 17, NULL),
(204, 168, 'Green', '17.00', 20, NULL),
(205, 168, 'Pink', '17.00', 17, NULL),
(206, 170, 'Choco', '28.00', 35, NULL),
(207, 170, 'Mango', '28.00', 45, NULL),
(208, 172, 'Ube', '71.00', 10, NULL),
(209, 172, 'Pandan', '71.00', 6, NULL),
(210, 172, 'Chocolate', '71.00', 4, NULL),
(211, 48, '100g', '27.50', 82, NULL),
(212, 48, '150g', '36.50', 53, NULL),
(213, 48, '175g', '41.50', 89, NULL),
(214, 48, '260g', '54.00', 12, NULL),
(215, 64, '95g', '27.50', 76, NULL),
(216, 64, 'hot 150g', '37.50', 77, NULL),
(217, 68, '100g', '19.00', 45, NULL),
(218, 68, '150g', '23.00', 47, NULL),
(219, 71, '150g', '25.00', 44, NULL),
(220, 71, '210g', '35.00', 48, NULL),
(221, 71, 'Big', '59.00', 50, NULL),
(222, 62, '100g', '16.00', 85, NULL),
(223, 62, '150g', '23.50', 127, NULL),
(224, 62, '170g', '25.00', 197, NULL),
(225, 62, 'Tocino', '26.50', 85, NULL),
(226, 69, 'Flat 85g', '32.00', 37, NULL),
(227, 69, '100g', '32.00', 100, NULL),
(228, 69, '155g', '40.00', 190, NULL),
(229, 38, '100g', '17.50', 156, NULL),
(230, 38, '150g', '22.75', 138, NULL),
(231, 38, '210g', '31.00', 93, NULL),
(232, 67, '100g', '20.50', 72, NULL),
(233, 67, '150g', '30.50', 67, NULL),
(234, 67, '175g', '34.00', 100, NULL),
(235, 65, 'Afrtitada', '29.75', 166, NULL),
(236, 65, 'Caldereta', '29.75', 166, NULL),
(237, 65, 'Hot and Spicy', '31.50', 50, NULL),
(238, 64, 'flakes 150g', '36.50', 74, NULL),
(239, 85, '100g', '20.00', 50, NULL),
(240, 85, '150g', '25.00', 50, NULL),
(241, 89, 'Green', '21.50', 43, NULL),
(242, 89, 'Red', '23.50', 50, NULL),
(243, 91, 'Green', '25.50', 97, NULL),
(244, 91, 'Red', '25.50', 98, NULL),
(245, 90, 'Green', '23.00', 50, NULL),
(246, 90, 'Red', '23.00', 50, NULL),
(247, 47, '100g', '11.75', 41, NULL),
(248, 47, '200g', '19.50', 42, NULL),
(249, 47, 'Buy 1 Take 1 (200g)', '29.00', 100, NULL),
(250, 47, '1L', '74.00', 48, NULL),
(251, 47, '1/2 gal.', '132.00', 50, NULL),
(252, 47, '1 gallon', '251.00', 50, NULL),
(253, 45, '150ml', '15.50', 73, NULL),
(254, 45, 'Buy 1 Take 1', '28.00', 50, NULL),
(255, 78, 'Buy 1 Take 1', '27.00', 20, NULL),
(256, 78, '1L', '69.00', 5, NULL),
(257, 34, '700ml', '141.00', 98, NULL),
(258, 34, '1L', '189.00', 79, NULL),
(259, 59, 'Light', '1008.00', 45, NULL),
(260, 59, 'Apple', '835.00', 49, NULL);
...
(31, 'Alfonso 1 1Liter', 'brandy-type spirit prepared with medium and high-strength wine spirits, 77% and 94% Alc./Vol. aged in oak casks. ', '301.00', 943, 'Beverages', 'https://i.ibb.co/jPyMQ6tH/2bf48b084634.png', '2025-03-31 15:21:29', '2025-10-06 23:40:21'),
(32, 'Alfonso 1 700mL', 'brandy-type spirit prepared with medium and high-strength wine spirits, 77% and 94% Alc./Vol. aged in oak casks. ', '234.00', 944, 'Beverages', 'https://i.ibb.co/wjnnCRK/7928f679733c.png', '2025-03-31 15:22:15', '2025-10-07 00:51:04'),
(33, 'Alfonso 1 1.75Liter', 'brandy-type spirit prepared with medium and high-strength wine spirits, 77% and 94% Alc./Vol. aged in oak casks. ', '649.00', 940, 'Beverages', 'https://i.ibb.co/N2t2GD8s/5da50a598cd4.png', '2025-03-31 15:22:59', '2025-09-18 20:13:03'),
(34, 'GSM Mojito', 'offers a refreshing blend of gin infused with mint and lime flavors, reminiscent of a traditional Mojito cocktail. It tends to have a crisp and citrusy profile with a hint of herbal notes from the mint.', '0.00', 72, 'Beverages', 'https://i.ibb.co/60Bw2QX7/6a76cc18e196.png', '2025-03-31 15:28:23', '2025-07-03 10:59:39'),
(36, 'Primera Light 750mL', 'A unique 55-proof brandy liqueur masterpiece made with fine imported ingredients from Spain. It is exquisitely blended with Solera Gran Reserva Brandy concentrate. Gives a distinctly flavorful aroma and exceptional taste. Delivering a light character and smooth throat-feel.', '140.00', 72, 'Beverages', 'https://i.ibb.co/0pCHgRnP/6b834d85cc3b.png', '2025-03-31 15:34:49', '2025-08-06 16:31:09'),
(37, 'Primera Light 1Liter', 'A unique 55-proof brandy liqueur masterpiece made with fine imported ingredients from Spain. It is exquisitely blended with Solera Gran Reserva Brandy concentrate. Gives a distinctly flavorful aroma and exceptional taste. Delivering a light character and smooth throat-feel.', '189.00', 92, 'Beverages', 'https://i.ibb.co/ZjVBQQm/54ecebf9dc9f.png', '2025-03-31 15:35:27', '2025-08-06 16:31:10'),
(38, 'Lucky 7 Corned Beef ', 'organic-free corned beef multipack', '0.00', 196, 'Canned Goods', 'https://i.ibb.co/MD9MDJ5q/d66d18901a73.png', '2025-03-31 15:37:33', '2025-07-03 10:36:10'),
(41, 'Lucky 7 Meat Loaf 150g', 'organic-free corned beef multipack', '22.50', 23, 'Canned Goods', 'https://i.ibb.co/tTMm9hg9/bf73f6e95a5d.png', '2025-03-31 15:42:51', '2025-09-30 23:06:28'),
(45, 'Datu Patis ', '#1 fish sauce in the Philippines.', '0.00', 95, 'Condiments', 'https://i.ibb.co/0Ry6CFm6/51d8ce58dd9f.png', '2025-03-31 17:25:10', '2025-07-03 10:55:44'),
(47, 'UFC Ketchup', 'unique blend of fresh spices and select bananas that provide the tamis anghang (sweet and spicy) flavor. ', '0.00', 100, 'Condiments', 'https://i.ibb.co/j9gnXrxH/cecb6672ce73.png', '2025-03-31 17:27:23', '2025-07-03 10:55:01'),
(48, 'Argentina Corned Beef', 'No. 1 corned beef brand that has the food qualities consumer most value', '0.00', 100, 'Canned Goods', 'https://i.ibb.co/W46GfnGB/d19d7b986670.png', '2025-03-31 17:32:37', '2025-07-03 10:28:05'),
(50, 'Primera Light 1Liter', 'a unique 55-proof brandy liqueur masterpiece', '185.00', 11, 'Beverages', 'https://i.ibb.co/ZjVBQQm/54ecebf9dc9f.png', '2025-03-31 17:41:56', '2025-09-16 01:01:08'),
(51, 'May Sparkle Red', 'A non-alcoholic beverage from freshly-pressed and carefully-selected Belgium Grapes.', '0.00', 6, 'Beverages', 'https://i.ibb.co/Wv5gFDjr/d75fc84e5138.png', '2025-03-31 17:43:28', '2025-04-01 01:04:28'),
(52, 'Novellino 750mL', 'Novellino Wild Blackberry is a casual wine vinified from choice vitis vinifera grapes in the tradition of fine Italian winemaking', '270.00', 10, 'Beverages', 'https://i.ibb.co/278v021y/05b8707b2772.png', '2025-03-31 17:45:11', '2025-09-15 22:33:52'),
(53, 'The Bar Dry Gin 335mL ', ' a world-class gin infused with imported botanicals from Spain that gives it a delicious burst of flavor not found in local gin products', '55.00', 6, 'Beverages', 'https://i.ibb.co/jkNpPRn2/4cd7e58417a4.png', '2025-03-31 17:46:37', '2025-04-16 15:31:00'),
(54, 'The Bar Pink 335mL', ' a world-class gin infused with imported botanicals from Spain that gives it a delicious burst of flavor not found in local gin products', '55.00', 58, 'Beverages', 'https://i.ibb.co/hxGrvfmq/a6f137b5983c.png', '2025-03-31 17:47:16', '2025-05-18 14:14:33'),
(55, 'The Bar Lime 335mL', ' a world-class gin infused with imported botanicals from Spain that gives it a delicious burst of flavor not found in local gin products', '55.00', 6, 'Beverages', 'https://i.ibb.co/8gggkGVx/49ad7f791839.png', '2025-03-31 17:47:46', '2025-08-06 16:31:29'),
(56, 'Emperador 750mL', ' brand of cut brandy and brandy produced by Emperador Inc.', '142.00', 50, 'Beverages', 'https://i.ibb.co/mrbVVg4L/daf1bf6947ad.png', '2025-03-31 17:51:17', '2025-04-01 01:18:46'),
(57, 'Emperador 1Liter', ' brand of cut brandy and brandy produced by Emperador Inc.', '185.00', 46, 'Beverages', 'https://i.ibb.co/VckXJTFG/ecd6f3d61a21.png', '2025-03-31 17:52:01', '2025-08-06 16:31:33'),
(58, 'Red Horse Beer per Case', 'beer', '617.00', 60, 'Beverages', 'https://i.ibb.co/F4fd74z2/2843dba65b63.png', '2025-04-01 01:27:22', '2025-09-23 23:12:32'),
(59, 'San Mig Light || Apple per Case', 'flavored beer', '0.00', 52, 'Beverages', 'https://i.ibb.co/dwTNCfJV/b0926c017020.png', '2025-04-08 04:30:05', '2025-07-03 11:07:55'),
(60, 'Ginebra per Case', 'delivers a clean, juniper-forward taste, complemented by subtle hints of citrus and spice', '1554.00', 187, 'Beverages', 'https://i.ibb.co/C3MZ5YvK/0b2cffba62af.png', '2025-04-08 04:59:46', '2025-09-23 23:18:57'),
(61, 'San Miguel Beer per case', 'full-flavored taste complements its pleasant aroma, making it a perfectly balanced beer', '599.00', 29, 'Beverages', 'https://i.ibb.co/FqyQ2D5Z/2b8cb868bbda.png', '2025-04-08 05:03:06', '2025-04-20 01:00:51'),
(62, 'Argentina Meat Loaf', 'made from quality meat that''s seasoned with the most flavorful yet kid-friendly spices', '0.00', 99, 'Canned Goods', 'https://i.ibb.co/zTRL3z2K/67acda401865.png', '2025-04-08 05:13:02', '2025-07-03 10:33:38'),
(63, 'Wow Ulam', 'brand of canned and fresh processed meat products from Century Pacific Food Inc.', '23.00', 53, 'Canned Goods', 'https://i.ibb.co/nNMdv4zm/8eaa96b1b065.png', '2025-04-08 06:09:14', '2025-09-23 23:16:37'),
(64, 'Century Tuna', 'a leading canned tuna brand in the Philippines, known for its healthy, delicious, and convenient options,', '0.00', 150, 'Canned Goods', 'https://i.ibb.co/FbXNJm1m/c00050cbdeba.png', '2025-04-08 06:14:26', '2025-07-03 10:41:53'),
(65, 'Blue Bay', 'Manamis-namis. Deliciously irresistible. Unmistakably fresh. The sea`s bounty and farm`s harvest make one delightful feast.', '0.00', 199, 'Canned Goods', 'https://i.ibb.co/vxtvqDpM/cc9c981cfeb3.png', '2025-04-08 06:18:53', '2025-07-03 10:39:02'),
(66, '555 Tuna', 'the “Super Ulam Pinoy” because it is rich in calcium for stronger bones, protein for muscle building, lycopene for cancer prevention', '26.00', 45, 'Canned Goods', 'https://i.ibb.co/Y7jbJpZ9/0f06ee53e48d.png', '2025-04-08 06:21:01', '2025-09-22 23:42:31'),
(67, 'CDO Karne Norte', 'a Filipino-style corned beef that has a delicious guisado taste', '0.00', 99, 'Canned Goods', 'https://i.ibb.co/KjNHwTmS/6ef04ff0da58.png', '2025-04-08 06:23:53', '2025-07-03 10:37:55'),
(68, 'Bingo Corned Beef', 'a canned, ready-to-eat corned beef product, specially prepared with beef and savory seasonings, and fortified with zinc and iron', '0.00', 50, 'Canned Goods', 'https://i.ibb.co/BH4TXJBC/d226081191f0.png', '2025-04-08 06:26:27', '2025-07-03 10:30:03'),
(69, 'San Marino', 'has the delicious taste and health benefits of tuna', '0.00', 100, 'Canned Goods', 'https://i.ibb.co/ns3PXZPS/e9feba69ac43.png', '2025-04-08 06:34:10', '2025-07-03 10:34:52'),
(70, 'Fresca Tuna', 'It''s a great alternative to the usual sardines, giving you more value for your money while staying within your budget.', '26.50', 93, 'Canned Goods', 'https://i.ibb.co/j9QJQfM7/2e963da1932c.png', '2025-04-08 06:37:38', '2025-09-22 23:53:16'),
(71, 'Hunts Pork and Beans', '#1 brand of Pork & Beans in the Philippines. It is made from high quality Great Northern Beans and real pork bits covered in rich, thick, sweet tomato sauce.', '0.00', 50, 'Canned Goods', 'https://i.ibb.co/rGVdMcgd/716c7cd11ed1.png', '2025-04-08 06:39:42', '2025-07-03 10:31:15'),
(72, 'Bear Brand', ' a Nestlé-owned milk brand, particularly popular in the Philippines, offering both sterilized milk and fortified powdered milk drinks, known for providing essential nutrients and supporting overall health and well-being. ', '0.00', 150, 'Milk and Chocolate Drink', 'https://i.ibb.co/1fKNBZTT/b2969e594b9d.png', '2025-04-08 06:52:24', '2025-06-26 22:11:21'),
(73, 'Bear Brand Adult', 'a powdered milk drink specially formulated for adults aged 19-29, designed to provide essential nutrients, including calcium, vitamin D, and B-vitamins, to support energy and immunity, and help close daily nutrition gaps. ', '0.00', 14, 'Milk and Chocolate Drink', 'https://i.ibb.co/3mr1fM35/60153400556e.png', '2025-04-08 06:58:08', '2025-06-26 22:14:57'),
(74, 'Bear Brand Choco', ' a chocolate-flavored powdered milk drink fortified with essential nutrients like iron, zinc, and vitamin C, designed for individuals aged 3 and up to support strong immunity and overall well-being', '0.00', 1221, 'Milk and Chocolate Drink', 'https://i.ibb.co/nMPC557v/b9527d3d54b3.png', '2025-04-08 07:00:50', '2025-06-26 22:12:26'),
(75, 'Milo', 'a chocolate-flavored malted beverage powder created by Nestlé, known for its unique choco-malty flavor and often mixed with milk or water to create a nutritious and delicious drink, especially popular among children and those seeking an energy boost. ', '0.00', 42547, 'Milk and Chocolate Drink', 'https://i.ibb.co/7NrmLyxz/6d157cac0a1f.png', '2025-04-08 07:05:20', '2025-06-26 22:24:28'),
(76, 'Birch Tree', ' known for its affordable price and high-quality nutrition, with a focus on fortified milk for children and adults. ', '0.00', 22, 'Milk and Chocolate Drink', 'https://i.ibb.co/xK9CjyBV/e407420a9dcb.png', '2025-04-08 07:10:11', '2025-06-26 22:31:05'),
(77, 'Del Monte Ketchup', 'made from real, high-quality tomatoes, naturally contains lycopene, and is guaranteed to have no preservatives, offering a rich tomato flavor and a sweet-sour taste for delicious dips and meals', '49.00', 18, 'Condiments', 'https://i.ibb.co/jmzv3ZM/728ac9940fe7.png', '2025-04-08 14:48:17', '2025-06-13 09:16:24'),
(78, 'Lorins Patis', 'a popular, tangy Filipino fish sauce, ideal as a dipping sauce or cooking ingredient for a wide variety of dishes, including seafood, meat, poultry, vegetables, and Filipino favorites like sinigang and nilaga. ', '0.00', 20, 'Condiments', 'https://i.ibb.co/3yZ5qszC/df3e929a28ec.png', '2025-04-08 15:02:19', '2025-07-03 10:56:23'),
(79, 'Sugar per kg', 'brown and white refined', '72.00', 247, 'Condiments', 'https://i.ibb.co/xK5TGqzf/2eb5e49aefb7.png', '2025-04-08 15:06:43', '2025-09-24 18:39:47'),
(80, 'Salt per kg', 'sea salt', '12.00', 118, 'Condiments', 'https://i.ibb.co/j9LdB8xH/50a57d229f22.png', '2025-04-08 15:08:19', '2025-09-30 23:08:42'),
(81, 'Paminta per Tie', 'whole and ground black pepper', '8.00', 71, 'Condiments', 'https://i.ibb.co/N6RqFRg8/3912cb5cc3e9.png', '2025-04-08 15:10:07', '2025-09-30 23:02:13'),
(82, 'Laurel per Tie', 'is an evergreen plant used to add flavor to dishes. It is used in cuisines all over the world for flavoring especially stews and broths, marinades, meat and fish dishes, gravies, and game.', '8.00', 23, 'Condiments', 'https://i.ibb.co/1Gg3Rqmt/c68fa580806f.png', '2025-04-08 15:11:30', '2025-09-30 22:56:42'),
(83, 'Mafran Banana Catsup', 'formulated from choice spices, natural flavor and aroma of banana', '95.00', 21, 'Condiments', 'https://i.ibb.co/jP5X36rq/dc20ac6e0fce.png', '2025-04-08 15:13:42', '2025-09-20 19:43:55'),
(84, 'Dip Catsup Gallon', 'often used as a dip or a topping for various dishes, characterized by its sweet and tangy flavor', '99.00', 6, 'Condiments', 'https://i.ibb.co/KjDjv9WP/00bb85cf904b.png', '2025-04-08 15:15:01', '2025-09-18 18:19:56'),
(85, '555 Karne Norte', ' a locally manufactured corned beef, known for its quality and affordability, made with selected beef, hashed, and hygienically processed under international standards, ready to eat. ', '0.00', 24, 'Canned Goods', 'https://i.ibb.co/xtWHP4pc/d786693a1768.png', '2025-04-08 15:17:10', '2025-09-17 00:11:04'),
(86, '555 Tausi', 'a popular Filipino canned food featuring fried sardines in a savory-sweet sauce with the distinct flavor of fermented black beans (tausi)', '33.00', 10, 'Canned Goods', 'https://i.ibb.co/B5zmwwY5/47dcc1b0cebc.png', '2025-04-08 15:18:12', '2025-04-08 15:18:12'),
(89, 'Lucky 7 Sardines', ' a budget-friendly, canned sardine option in tomato sauce, known for their savory taste and affordability, making them a popular choice for daily meals. ', '0.00', 45, 'Canned Goods', 'https://i.ibb.co/JRzY9m7R/054a358ac5dc.png', '2025-04-08 15:26:01', '2025-07-03 10:49:40'),
(90, 'Atami Sardines', 'A delightful and flavorful seafood choice that combines the natural goodness of sardines', '0.00', 50, 'Canned Goods', 'https://i.ibb.co/sdNR2j4f/0f5b60542f2a.png', '2025-04-08 15:28:21', '2025-07-03 10:51:53'),
(91, 'Master Sardines', 'known for their premium quality, sourced from the depths of the ocean and expertly preserved to retain natural flavors and nutritional goodness, with a focus on a quick catch-to-can process. ', '0.00', 95, 'Canned Goods', 'https://i.ibb.co/ksGrTmWD/8c3590d7e350.png', '2025-04-08 15:31:56', '2025-09-17 00:11:03'),
(92, 'trytry test', 'jm garis', '100.00', 20, 'Beverages', 'https://i.ibb.co/pjrnNm07/59cc32c572c3.jpg', '2025-05-18 15:05:23', '2025-06-11 00:38:19'),
(97, 'Saba Mackarel', 'Saba mackerel, also known as Japanese mackerel or blue mackerel, is a flavorful and oily fish, particularly prized in Japanese cuisine', '0.00', 120, 'Canned Goods', 'https://i.ibb.co/ZRkbT3RJ/0e0921a17a8a.png', '2025-06-18 04:49:21', '2025-06-18 07:20:57'),
(98, 'Mega Mackarel', '155g, Mega Mackerel is a canned mackerel product known for its big, flavorful chunks and versatility in Filipino dishes.', '33.00', 12, 'Canned Goods', 'https://i.ibb.co/6cB1crnb/dd7ac057568c.png', '2025-06-18 04:51:19', '2025-09-22 23:45:21'),
(99, 'Saba Sardines Large', 'Saba sardines are a popular brand of canned sardines known for their firm, meaty texture and distinct flavor, particularly in the Philippines. ', '0.00', 100, 'Canned Goods', 'https://i.ibb.co/rfs5Z80w/b381e12b66d0.png', '2025-06-18 04:53:45', '2025-06-18 17:30:25'),
(100, 'Saba Squid', 'Saba squid, specifically referring to products like "Saba Squid in Soy Sauce" or "Saba Squid Sisig," is a Filipino delicacy featuring tender squid pieces cooked and preserved in a savory sauce, often with soy sauce and chili. ', '0.00', 70, 'Canned Goods', 'https://i.ibb.co/0jfpC22s/6b0257b01d55.png', '2025-06-18 04:56:21', '2025-06-18 17:30:44'),
(101, 'Mega Squid', 'A mega squid, as depicted in The Future is Wild, is a large, terrestrial, omnivorous animal, standing 4 meters tall and weighing 8 tonnes, with a body structure that is a mix of squid and terrestrial animal features', '0.00', 30, 'Canned Goods', 'https://i.ibb.co/CsXsKJQT/bb0835eb7714.png', '2025-06-18 04:58:29', '2025-06-18 07:25:50'),
(102, 'Rosebowl Sardines', 'They are a classic and well-regarded brand, often described as a favorite among many generations. The sardines are packed in a flavorful tomato sauce, and some varieties include a spicy chili kick', '0.00', 100, 'Canned Goods', 'https://i.ibb.co/MyCtkwpC/da06407e203a.png', '2025-06-18 05:01:09', '2025-06-18 17:28:34'),
(103, 'MaLing', 'Maling is a brand of canned luncheon meat, often made with pork, that is popular in Asia, particularly in the Philippines and other Southeast Asian countries. It''s known for its savory and slightly salty flavor, smooth texture, and versatility in various dishes. ', '0.00', 48, 'Canned Goods', 'https://i.ibb.co/SzRjMZP/499e0e083344.png', '2025-06-18 05:03:03', '2025-06-18 17:31:03'),
(104, 'TigaBunga Squid', 'Tiga Bunga is a brand known for its canned squid in natural ink', '0.00', 62, 'Canned Goods', 'https://i.ibb.co/hNbLLDr/0afd5347f839.png', '2025-06-18 05:05:07', '2025-06-18 17:37:51'),
(105, 'Reno Liver Spread', 'Reno Liver Spread is a Filipino canned liver spread, typically made from a mixture of pureed pork liver, poultry meat, cereals, vegetable oil, and spices.', '0.00', 160, 'Canned Goods', 'https://i.ibb.co/ZRds181S/2d7e7dcbc1ad.png', '2025-06-18 05:11:53', '2025-06-18 17:29:20'),
(106, 'Philips Sausage', 'Philips is a well-known food brand in the Philippines, recognized for its canned goods, particularly its Vienna sausage. Philips Vienna Sausage is known for its quality and affordable price, making it a popular choice for Filipino families.', '26.00', 30, 'Canned Goods', 'https://i.ibb.co/1fXgkHCY/93501a584679.png', '2025-06-18 05:13:30', '2025-06-18 05:13:30'),
(107, 'Koolers per Box', 'Koolers is a brand of juice drinks known for their fruity and refreshing flavors, often marketed as a fun and healthy way to start the day', '0.00', 200, 'Beverages', 'https://i.ibb.co/zhdYJH9K/9cd95abc48cc.png', '2025-06-18 05:18:31', '2025-06-18 17:38:09'),
(108, 'Wilkins 7 Liter', 'a brand of purified drinking water, recognized for its quality and safety.', '88.00', 7, 'Beverages', 'https://i.ibb.co/yn8NpYs2/67e034629cb9.png', '2025-06-18 05:20:07', '2025-09-20 19:43:56'),
(109, 'Refresh Mineral 350mL (sold per case)', 'a brand of bottled water known for its natural, clean taste, sourced directly from springs, and its eco-friendly packaging', '150.00', 13, 'Beverages', 'https://i.ibb.co/F13xwP6/641c5d6df4ec.png', '2025-06-18 05:21:40', '2025-09-22 23:54:52'),
(110, 'Cobra (per case)', 'Cobra is an energy drink, primarily available in the Philippines, known for its orange flavor and ability to provide an energy boost', '207.00', 19, 'Beverages', 'https://i.ibb.co/n8ZzykdX/79aa8145fe83.png', '2025-06-18 05:24:11', '2025-09-20 01:01:06'),
(111, 'Sting (per case)', 'Sting is a carbonated energy drink, produced by PepsiCo Vietnam, designed to provide a boost of energy and focus.', '200.00', 23, 'Beverages', 'https://i.ibb.co/DfwDcqLh/ad3f161a5e26.png', '2025-06-18 05:25:06', '2025-09-22 23:57:19'),
(112, 'Mountain Dew (per case)', 'Mountain Dew is a citrus-flavored, caffeinated soft drink known for its unique, tangy taste and vibrant, slightly neon green color. It''s a popular choice for those seeking a refreshing, energizing beverage, often enjoyed during activities or with meals.', '192.00', 95, 'Beverages', 'https://i.ibb.co/YBRdJfsP/d62cc77c8cd9.png', '2025-06-18 05:25:58', '2025-09-23 23:18:58'),
(113, 'Coke/Royal/Sprite Mismo (per case)', 'Coke, Royal, and Sprite, all from The Coca-Cola Company, are popular carbonated soft drinks.', '0.00', 200, 'Beverages', 'https://i.ibb.co/ksMvMh8H/eccf0110a173.png', '2025-06-18 05:28:32', '2025-06-18 05:31:28'),
(114, '1.5L Coke/Royal/Sprite (per case)', 'Coke, Royal, and Sprite, all from The Coca-Cola Company, are popular carbonated soft drinks.', '0.00', 30, 'Beverages', 'https://i.ibb.co/Y7W1c1pc/5ca33bf6a13a.png', '2025-06-18 05:31:03', '2025-06-18 17:38:30'),
(115, 'Rebisco Crackers', 'Rebisco Crackers are a classic Filipino snack known for their light, crispy texture and subtle, slightly salty taste. ', '58.00', 32, 'Biscuits', 'https://i.ibb.co/dsfRcZN6/130d3bde1284.png', '2025-06-18 06:31:05', '2025-09-22 23:57:20'),
(116, 'Flavored Rebisco Crackers', 'Rebisco offers a variety of flavored cracker sandwiches with creamy fillings. Popular flavors include chocolate, strawberry, cream, and butter, often sold in packs of 10. Some also feature peanut butter or pastillas fillings. Rebisco also offers whole wheat crackers and other flavored options like honey butter. ', '0.00', 90, 'Biscuits', 'https://i.ibb.co/9k7PNJ5m/4a91171d5a1d.png', '2025-06-18 06:34:03', '2025-06-18 17:38:48'),
(117, 'Frootees', 'Frootees are a line of flavored shortcake cookies, marketed as a nutritious and filling snack for kids. They are known for being high in Vitamin C and Zinc, which are believed to boost the immune system and potentially improve focus.', '58.00', 143, 'Biscuits', 'https://i.ibb.co/yBPRRSdC/ab0f7e9ac462.png', '2025-06-18 06:38:31', '2025-09-22 23:48:27'),
(118, 'Rebisco Extreme', 'Rebisco Extreme is a chocolate-flavored biscuit that features a combination of chocolate crackers, a chocolate filling, a chocolate coating, and chocolate sprinkles', '58.00', 146, 'Biscuits', 'https://i.ibb.co/S73MB8X3/41a3498b084b.png', '2025-06-18 06:39:14', '2025-09-22 23:56:04'),
(119, 'Hansel Crackers', '12 pieces of creamy, sweet-salty plain crackers perfect for sharing with the family! Best paired with coffee, juice, spreads and toppings to cap off a long day with your loved ones!', '58.00', 136, 'Biscuits', 'https://i.ibb.co/TD3tB6wp/ee0a6c972314.png', '2025-06-18 06:40:24', '2025-09-22 23:27:31'),
(120, 'Flavored Hansel', 'Hansel sandwiches are soft, salty-sweet biscuit sandwiches with a creamy filling, available in a variety of flavors. They are known for their distinct aroma and are a popular Filipino snack. The "Flavor Bunch" variety includes Mocha, Milk, Chocolate, Butter, and Milky Strawberry flavors. ', '0.00', 750, 'Biscuits', 'https://i.ibb.co/bMM1N0hJ/e97cce0da8f0.png', '2025-06-18 06:44:52', '2025-06-18 17:39:05'),
(121, 'Combi', 'Combi biscuits, specifically the Rebisco Combi Triple Choco, are a snack consisting of a chocolate cream filling sandwiched between a crunchy chocolate cracker and a chocolate wafer.', '62.00', 50, 'Biscuits', 'https://i.ibb.co/1JjyTthp/80e642aa710b.png', '2025-06-18 06:45:46', '2025-09-24 18:39:46'),
(122, 'Choco Mucho (per box)', 'Choco Mucho biscuits are bite-sized treats known for their combination of rolled wafer, caramel, rice crispies, and creamy chocolate. ', '0.00', 50, 'Biscuits', 'https://i.ibb.co/67LSfJWD/6addd661a002.png', '2025-06-18 06:48:20', '2025-06-18 07:29:31'),
(123, 'Wafertime Rich Cream', 'Wafertime Rich Cream biscuits are flat wafer sandwiches with a rich, creamy filling. Rebisco''s Wafertime Rich Cream in particular, features a deliciously rich chocolate filling abundantly present in every bite. ', '70.00', 8, 'Biscuits', 'https://i.ibb.co/G3ftYQdJ/3ee6834bd091.png', '2025-06-18 06:50:17', '2025-09-23 23:16:33'),
(124, 'Super Thin ', 'Super thin biscuits are light, crispy, and delicate crackers, often described as having the texture of a chip. They are known for their thinness and satisfying crunch, often paired with a subtle sweetness and a hint of milk flavor. ', '0.00', 20, 'Biscuits', 'https://i.ibb.co/5X7t0yFM/8fb7551ce701.png', '2025-06-18 06:51:38', '2025-06-18 07:20:35'),
(125, 'Bravo Biscuit', 'known for their unique sweet-salty taste and are packed with vitamins B1, B2, and E. They feature a blend of sugar and sesame seeds, offering a distinctive flavor profile', '58.00', 13, 'Biscuits', 'https://i.ibb.co/Kc304qg6/fd1dbaceef5e.png', '2025-06-18 06:52:55', '2025-09-22 23:42:32'),
(126, 'Rebisco Honey Butter', 'Rebisco Honey Butter Crackers are crunchy, sweet and savory biscuits. They are flavored with honey and butter, and have a subtle sweetness from the honey and a rich, buttery taste.', '58.00', 13, 'Biscuits', 'https://i.ibb.co/WvyTfVmf/b17663b06ee9.png', '2025-06-18 07:07:04', '2025-09-24 18:39:46'),
(127, 'Fudgee Bar', 'Fudgee Barr is a popular Philippine snack, Fudgee Barr is available in various flavors, including chocolate, macapuno (coconut), milk, vanilla, mocha, and salted caramel. A combo pack with assorted flavors is also available. ', '0.00', 200, 'Biscuits', 'https://i.ibb.co/W4FMNyVL/6c0d792aad26.png', '2025-06-18 07:11:39', '2025-06-18 17:39:32'),
(128, 'Cupp Keyk Assorted', 'Cupp Keyk Assorted is a selection of Filipino-style mini cupcakes with a variety of flavors, known for their moist and delicious cake base and enjoyable toppings.', '67.00', 12, 'Biscuits', 'https://i.ibb.co/dJzzQhZQ/f0fd56b261e3.png', '2025-06-18 07:13:43', '2025-09-23 23:26:07'),
(129, 'Topps Sarap ', 'Topps Sarap is a brand of compact, single-serving cupcakes that are known for their rich and creamy filling, thick frosting, and toppings like star sprinkles', '0.00', 30, 'Biscuits', 'https://i.ibb.co/JFxPhLw5/3f865e3665f4.png', '2025-06-18 07:15:47', '2025-06-18 07:20:00'),
(130, 'Brownie Break', 'Brownie Break is a brand of individually wrapped, chewy, bite-sized brownies.', '75.00', 26, 'Biscuits', 'https://i.ibb.co/Ld2y9y6C/3f859b3e89e7.png', '2025-06-18 07:17:49', '2025-09-21 15:21:57'),
(131, '555 Karne Norte', ' a locally manufactured corned beef, known for its quality and affordability, made with selected beef, hashed, and hygienically processed under international standards, ready to eat. ', '0.00', 100, 'Canned Goods', 'https://i.ibb.co/XxwWhW35/12816c9121e9.png', '2025-06-18 08:18:16', '2025-06-18 08:18:42'),
(132, 'Ligo Sardines', 'Ligo sardines, a popular Filipino brand, are known for their high-quality sardines packed in a flavorful tomato sauce.', '0.00', 200, 'Canned Goods', 'https://i.ibb.co/xtf07ypV/9d9995cb1592.png', '2025-06-18 08:22:41', '2025-06-18 17:40:05'),
(133, 'Mega Sardines', 'Mega Sardines, the number one sardine brand in the Philippines, is known for its fresh, high-quality sardines caught and canned within 12 hours.', '0.00', 1000, 'Canned Goods', 'https://i.ibb.co/m5N1MgKp/dd37d6c182e1.png', '2025-06-18 08:24:18', '2025-06-18 08:24:30'),
(135, 'Kopiko Twin (10''s)', ' These twin packs are popular for their convenience and affordability, offering a creamy, delicious coffee experience. ', '0.00', 800, 'Coffee and Creamer', 'https://i.ibb.co/PsL7Vywf/3fed60dcca32.png', '2025-07-03 01:35:44', '2025-07-03 01:36:15'),
(136, 'Great Taste                                                                   ', 'Great Taste is a popular instant coffee brand known for its rich taste and aroma, offering a variety of flavors and formats to suit different preferences', '0.00', 600, 'Coffee and Creamer', 'https://i.ibb.co/mMrH77q/e5d62ff7e81b.png', '2025-07-03 01:43:25', '2025-07-03 01:44:35'),
(137, 'Nescafe Classic', 'Let the unmistakeable, full-flavoured Nescafé ® Classic instant coffee awaken your senses for a perfect morning moment, with an expert medium-dark roast.', '0.00', 400, 'Coffee and Creamer', 'https://i.ibb.co/rKh3ks8y/57ba9758c142.png', '2025-07-03 01:53:22', '2025-07-03 01:53:47'),
(138, 'Nescafe Twin', 'NESCAFE Original is the strong coffee mix that bring our delicious coffee taste and aroma that lasts from your first whiff until your last gulp.', '0.00', 420, 'Coffee and Creamer', 'https://i.ibb.co/QFj7Trn9/2dcce261df5a.png', '2025-07-03 02:01:46', '2025-07-03 02:01:59'),
(139, 'Kremtop', 'Krem-Top is a non-dairy coffee creamer known for its rich and creamy taste, designed to enhance the flavor of your coffee', '0.00', 280, 'Coffee and Creamer', 'https://i.ibb.co/7tfjcR80/f0dd134a2c03.png', '2025-07-03 02:35:16', '2025-07-03 02:36:40'),
(140, 'Coffeemate', 'Coffee-mate is a non-dairy coffee creamer, available in powdered, liquid, and concentrated liquid forms, that enhances the flavor and texture of coffee', '0.00', 250, 'Coffee and Creamer', 'https://i.ibb.co/ds1vyXTw/6ff408e99e4d.png', '2025-07-03 02:43:12', '2025-07-03 02:43:12'),
(141, 'Great Taste Granules', 'Great Taste Granules are a concentrated coffee product made from 100% granulated coffee beans, specifically Robusta beans.', '0.00', 400, 'Coffee and Creamer', 'https://i.ibb.co/dwkzGQ6y/1f2c32edd630.png', '2025-07-03 02:58:06', '2025-07-03 02:58:06'),
(142, 'Great Taste Premium', 'Great Taste Premium is a line of instant coffee products known for their rich taste and aroma, offering a satisfying coffee experience. ', '0.00', 300, 'Coffee and Creamer', 'https://i.ibb.co/HT7rBkmM/250bb357d0ef.png', '2025-07-03 03:00:18', '2025-07-03 03:00:43'),
(143, 'Magic Sarap', 'Magic Sarap is an all-in-one seasoning, popular in Filipino cuisine, known for its rich, savory, and umami flavor', '0.00', 399, 'Condiments', 'https://i.ibb.co/v4Bvk94x/aebe31d0852f.png', '2025-07-03 03:07:41', '2025-09-21 15:35:59'),
(144, 'Ajinomoto', 'Ajinomoto, also known as monosodium glutamate (MSG), is a flavor enhancer, commonly used in various cuisines, particularly in Asian dishes like Chinese cuisine.', '0.00', 500, 'Condiments', 'https://i.ibb.co/DHHsNNDc/ef7355ba13c2.png', '2025-07-03 03:12:37', '2025-07-03 03:12:37'),
(145, 'Ajiginisa', 'a Filipino seasoning mix, primarily used to enhance the flavor of stir-fried dishes and other savory meals', '57.00', 46, 'Condiments', 'https://i.ibb.co/MkBW7cff/788460e027c6.png', '2025-07-03 03:14:18', '2025-09-23 23:12:34'),
(146, 'Knorr Cubes', 'AI Overview
Knorr Chicken Cubes Savers | 10g x 12 cubes
Knorr cubes are concentrated flavor enhancers, specifically bouillon cubes, designed to add depth and richness to various dishes.', '0.00', 800, 'Condiments', 'https://i.ibb.co/DP8g5SwV/5c1d882d6cbe.png', '2025-07-03 03:18:39', '2025-07-03 03:18:39'),
(147, 'Knorr Sinigang', 'Knorr Sinigang is a Filipino soup known for its sour and savory flavor, with tamarind as the primary souring agent', '0.00', 105, 'Condiments', 'https://i.ibb.co/YFVBm4Cw/02cd78e6e8ea.png', '2025-07-03 03:31:35', '2025-07-03 03:31:35'),
(148, 'Color Rumble Lollipop', 'Lipps assorted, 50pcs per pack', '63.00', 12, 'Candies and Snacks', 'https://i.ibb.co/Y4sv7XSg/b11c1bfcb5ea.png', '2025-07-03 03:35:02', '2025-09-23 23:10:48'),
(149, 'Frooty Rainbow Pop', 'assorted lollipop', '33.00', 12, 'Candies and Snacks', 'https://i.ibb.co/fYs7CNx9/da50be0a43b1.png', '2025-07-03 03:36:13', '2025-09-22 23:33:30'),
(150, 'Stay Fresh Candy', 'menthol candies', '37.00', 16, 'Candies and Snacks', 'https://i.ibb.co/N6SfV7sv/6024d6b38bc1.png', '2025-07-03 03:37:44', '2025-09-22 23:33:31'),
(151, 'Snow Bear Candy', 'menthol candy', '95.00', 85, 'Candies and Snacks', 'https://i.ibb.co/fYTg2h2T/3b252006328f.png', '2025-07-03 03:38:49', '2025-09-22 23:40:46'),
(152, 'Krimstix Jumbo', 'a creamy, flavored paste, available in chocolate, milk, pandan, peanut butter, ube, cookies & cream, and cheesy crunch, among other flavors', '0.00', 99, 'Candies and Snacks', 'https://i.ibb.co/vvJBNFrm/591a3cb7bf9a.png', '2025-07-03 03:41:11', '2025-09-17 00:04:28'),
(153, 'Frutos', 'a Filipino brand of soft, chewy candy, known for its tropical fruit and tamarind (sampalok) flavors', '0.00', 86, 'Candies and Snacks', 'https://i.ibb.co/kVBkdL72/b06bc349ca4b.png', '2025-07-03 03:42:34', '2025-07-03 03:42:34'),
(154, 'Sweet Candies', 'a sweet confection made primarily from sugar or other sweeteners, often with added flavors, fruits, chocolate, or nuts. ', '0.00', 119, 'Candies and Snacks', 'https://i.ibb.co/XqP33f3/41ca766e4d2b.png', '2025-07-03 03:45:58', '2025-09-17 17:15:31'),
(155, 'Cloud 9', 'Cloud 9 candy, a popular Filipino snack, is a chocolate bar featuring a combination of luscious caramel, crunchy peanuts, and soft nougat, all wrapped in a rich chocolate coating.', '0.00', 70, 'Candies and Snacks', 'https://i.ibb.co/9m42v2cQ/b80156045f00.png', '2025-07-03 03:48:14', '2025-07-03 03:48:14'),
(156, 'Beng-beng ', '12 pcs per box Bengbeng is a popular Indonesian chocolate snack, described as a chocolate-covered wafer with multiple layers', '88.00', 44, 'Candies and Snacks', 'https://i.ibb.co/CspY4t1D/9f7cb706b1fd.png', '2025-07-03 03:49:51', '2025-09-22 23:40:47'),
(157, 'Choco Mucho', 'Choco Mucho is a bite-sized chocolate snack made by Rebisco featuring layers of rolled wafer, caramel, and rice crispies, all coated in creamy chocolate.', '0.00', 59, 'Candies and Snacks', 'https://i.ibb.co/ZR5Lx9Rt/9b5e6320333f.png', '2025-07-03 03:53:03', '2025-09-22 23:33:31'),
(158, 'Maxx', 'Maxx candy, introduced by Jack ''n Jill, is a menthol-flavored candy known for its refreshing and cooling sensation, often enjoyed for its potential to relieve sore throats or nasal congestion.', '0.00', 600, 'Candies and Snacks', 'https://i.ibb.co/HLfNFgbb/95c20568e4d3.png', '2025-07-03 03:58:42', '2025-07-03 03:58:42'),
(159, 'Wings Powder 6''s', 'Wings powder, specifically referring to laundry detergent powder like Wings Solve, is designed for cleaning clothes and offers a few key benefits. ', '0.00', 400, 'Bar and Soap', 'https://i.ibb.co/DDHNs1sK/f580b3cc19f1.png', '2025-07-03 04:05:02', '2025-07-03 04:05:02'),
(160, 'Surf Powder 6''s', 'Surf powder is a laundry detergent known for its cleaning power and fragrance.', '0.00', 797, 'Bar and Soap', 'https://i.ibb.co/rRvpNQ4Z/4319fe2af7ea.png', '2025-07-03 04:07:22', '2025-09-17 17:25:01'),
(161, 'Ariel Powder 6+1', 'Ariel is a brand of laundry detergent, and Ariel powder is a powdered form of their detergent designed for cleaning clothes.', '95.00', 33, 'Bar and Soap', 'https://i.ibb.co/Gftz7zQG/0d7648342246.png', '2025-07-03 04:08:30', '2025-09-22 23:38:06'),
(162, 'Tide Powder 6+1', 'Tide powder detergent is a laundry cleaning agent designed for both standard and high-efficiency washing machines, as well as handwashing', '95.00', 47, 'Bar and Soap', 'https://i.ibb.co/qMrGTn9b/b17af808fb31.png', '2025-07-03 04:09:21', '2025-09-20 01:07:01'),
(163, 'Breeze Powder 6+1', 'Breeze powder detergent is a laundry cleaning product known for its stain-removing capabilities.', '86.00', 28, 'Bar and Soap', 'https://i.ibb.co/ch6SHn0Y/df5f2b17a486.png', '2025-07-03 04:10:16', '2025-09-17 17:37:06'),
(164, 'Pride Powder', 'Pride Powder is a laundry detergent known for its "stain-away" formula that effectively removes dirt and stains, leaving clothes clean and fresh', '0.00', 30, 'Bar and Soap', 'https://i.ibb.co/jPpk0N8H/83494c4c564d.png', '2025-07-03 04:12:25', '2025-07-03 04:12:25'),
(165, 'Wings Powder 1kg', 'Wings powder detergent offers a deep clean, removing dirt and leaving clothes with a fresh, long-lasting scent', '105.00', 6, 'Bar and Soap', 'https://i.ibb.co/LDxKhgpM/d2d605567151.png', '2025-07-03 10:01:33', '2025-09-21 15:29:25'),
(166, 'Safeguard Bar Soap', '2 flavors, floral pink and lemon fresh', '0.00', 200, 'Bar and Soap', 'https://i.ibb.co/rRQ4QpKn/2c418ec426fd.png', '2025-07-03 10:05:07', '2025-07-03 10:05:07'),
(167, 'Silka Bar Soap 65g', 'Silka is a Filipino skincare brand known for its affordable and effective products, particularly those focused on skin whitening and moisturizing', '0.00', 180, 'Bar and Soap', 'https://i.ibb.co/DPBwyK4X/7555a0ca60fd.png', '2025-07-03 10:08:52', '2025-07-03 10:08:52'),
(168, 'Bioderm Sachet', 'Bioderm is a family germicidal soap that offers 99.9% germ-killing action and up to 24-hour protection against germs that can cause illness and body odor', '0.00', 60, 'Bar and Soap', 'https://i.ibb.co/3mrwNgBh/f11cfcf54309.png', '2025-07-03 10:11:54', '2025-07-03 10:11:54'),
(169, 'Top Coffee Tripid (10''s)', '3 packs per sachet, a total of 30 packs', '139.00', 188, 'Coffee and Creamer', 'https://i.ibb.co/N6V8Ch58/062230b4f2a1.png', '2025-07-03 10:14:50', '2025-09-23 23:20:07'),
(170, 'O-Puff', 'O-Puff is a brand of cream-filled marshmallows produced by Oishi.', '0.00', 100, 'Candies and Snacks', 'https://i.ibb.co/wZvtjvYb/3af922cb5a22.png', '2025-07-03 10:19:49', '2025-07-03 10:19:49'),
(171, 'Polvoron (24''s)', 'Polvoron is a Filipino-style shortbread made of toasted flour, powdered milk, sugar, and butter. Sweet, buttery, and easy to customize with different flavors.', '24.00', 45, 'Candies and Snacks', 'https://i.ibb.co/pjxsNdkn/8a208d83c9a7.png', '2025-07-03 10:22:04', '2025-09-21 15:20:33'),
(172, 'Superstix ', 'Superstix are crunchy wafer sticks produced by Rebisco, known for their creamy, flavorful fillings.', '0.00', 29, 'Candies and Snacks', 'https://i.ibb.co/wh17M6H0/55bdc4ede310.png', '2025-07-03 10:24:49', '2025-09-17 20:30:37');
...
-- Data for table: receipt_settings
...
Please come again', 'You can Contact us in: +63*** *** ****', '2025-06-13 14:06:01', '2025-08-05 04:50:03');
...
DROP TABLE IF EXISTS `user_loyalty_status`;
...
(10, 1014, NULL, '740.00', '0.00', '0.00', NULL, NULL, '2025-09-16 01:01:12');
...
(1014, 'L4nszxc', 'Lans Lorence', 'Navarro', 'Hernandez', 'male', 'single', '09127649805', 'Ibaba West, Calapan City, Oriental Mindoro', '2004-07-08 16:00:00', 'lanslorence@gmail.com', '$2a$10$LqL9bOD8WT5e6N3imT6sBuXzplQHVei0k7jaCayx06isCEGWD9oEi', '2025-09-13 21:52:17', NULL, NULL, 1, 'user', NULL, NULL, 'https://i.ibb.co/rK5pDFW6/c16d7f8c3d18.jpg', 0),
...
(1016, 's_chi', 'Sachilette', NULL, 'Leyesa', 'female', 'single', '09939048662', 'Sitio Pag-Asa, Calapan City Oriental Mindoro', '2004-02-24 16:00:00', 'saaach25@gmail.com', '$2a$10$dbtzNKfDPFZoNZX657WCS.aSU30mzUH15iDuUMZHiIv.E11fcNPJK', '2025-09-16 00:20:49', NULL, NULL, 1, 'user', NULL, NULL, 'https://i.ibb.co/spLXdnPQ/07d9b6e689ff.jpg', 0),
